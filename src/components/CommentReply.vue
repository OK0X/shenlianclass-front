  ...
  <div class="page-content" style="margin-top:5px;">
    <div class="flex-col" v-show="myanswer!==''">
      ...
      <div style="display:flex;">
        ...
        <img v-show="option.showCai"
          :src="myanswer.cai?'statics/cai-click.png':'statics/cai-black.png'"
          class="zan-cai"
          @click="zancaiAnswer(myanswer,'cai')"
        />
        <span class="zan-cai-num" v-show="option.showCai">{{myanswer.disagree}}</span>
        <img
    ...
    <div class="flex-col" v-if="acceptanswer!==''&&acceptanswer.user_id!==user.uuid">
      ...
      <div v-html="acceptanswer.content" style="margin:10px 0 10px 0;font-size: 16px;" v-highlight></div>
      <div style="display:flex;">
        <img
    ...
    <div class="flex-col" v-for="(item,index) in answers" :key="index">
      ...
      <div style="display:flex;">
        ...
        <div style="display:flex;" v-show="ask.hasaccept||user.uuid!==ask.user_id">
          ...
          />
          <span class="zan-cai-num" v-show="option.showCai">{{item.disagree}}</span>
        </div>
        <img
          src="statics/reply.png"
          class="comment-icon"
